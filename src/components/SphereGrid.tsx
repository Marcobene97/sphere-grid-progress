...
import { SphereNode as SphereNodeType } from '@/types';
...
const SphereNodeComponent = ({ data }: { data: SphereNodeType & { onClick: (node: SphereNodeType) => void } }) => {
  const getNodeColor = () => {
    switch (data.status) {
...
export const SphereGrid = ({ nodes, onNodeClick, onNodeUpdate }: SphereGridProps) => {
